...
//
//     const getAllRoadMapsSubscription = this.roadMapService.getAll()
//       .subscribe(value => this.roadMaps = value);
//     const getAllKpisSubscription = this.kpiService.getAllByProjectId(productId)
//       .subscribe(value => this.kpis = value);
//     const getAllTasksSubscription = this.mileStoneService.getAll()
//       .subscribe(value => this.mileStones = value);
//
//     const getAllActiveSprintsSubscription = this.taskService.getAllByParams('true', 'active')
//       .subscribe(value => this.activeTasks = value);
//     const getAllMembersSubscription = this.memberService.getAll()
